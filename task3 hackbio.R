...
upregulated_enrichments <- read.csv("https://raw.githubusercontent.com/Logykh/stage-2-hackbio/refs/heads/main/up.csv")
...
downregulated_enrichment <- read.csv("https://raw.githubusercontent.com/Logykh/stage-2-hackbio/refs/heads/main/down.csv")
